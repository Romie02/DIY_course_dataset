...
# if was in a folder would do targets <- read_tsv("folder/studydesign.txt")
...
# if it is in a specific folder like DAN path <- file.path("kallisto_outputs", targets$sample, "abundance.tsv") 
...
Txi_gene <- tximport(path, 
                     type = "kallisto", 
                     tx2gene = Tx, 
                     txOut = FALSE, #How does the result change if this =FALSE(gene level data) vs =TRUE(transcript level data)?
